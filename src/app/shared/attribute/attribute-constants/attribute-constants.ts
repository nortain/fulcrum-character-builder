...
export const INITIATIVE_TEXT = "Gain a bonus move action when rolling two odd numbers for initiative";
...
export class AttributeConstants {
  Brawn: AttributeModel;
  Agility: AttributeModel;
  Reasoning: AttributeModel;
  Presence: AttributeModel;
  Vitality: AttributeModel;
  Quickness: AttributeModel;
  SelfDiscipline: AttributeModel;
  Intuition: AttributeModel;
}
...
export function getAttributeObject(): AttributeConstants {
  return {
    ...
    Quickness: {
      ...
      epicText: INITIATIVE_TEXT,
      legendaryText: INITIATIVE_TEXT,
      bonusToTrainedSkills: ATTRIBUTE_TRAINED_SKILL_BONUS
    } as AttributeModel,
    SelfDiscipline: {
      ...new AttributeModel(),
