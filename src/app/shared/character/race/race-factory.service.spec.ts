...
describe('Race', () => {
  ...
  it('should be able to get a dwarf\'s tough as nails bonus in a formatted version for at level 5', () => {
    ...
    expect(service.formatText(burman, burman.activeBonuses[0].value)).toContain("minor action you gain 11 temporary hit points and");
  });
  ...
  it('should be able to format text for the human active power', function () {
    ...
    expect(service.formatText(human, human.activeBonuses[0].value)).toBe("As a minor action you can gain a +4 to hit with all attacks and any critical rolls gain 1 additional die until the end of your turn.");
  });
