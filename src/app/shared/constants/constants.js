...
exports.SpecialPower = exports.Feature = exports.KeyValuePair = exports.Knack = exports.StartingCharacterMagicDefense = exports.SUBTHEME_BONUS = exports.TWO_MAGIC_SPELLS = exports.ONE_MAGIC_SPELLS = exports.STEALTH_INIT_BONUS = exports.REQUIRES_THREE_MAGIC = exports.REQUIRES_TRAINING = exports.SKILL_PENALTY = exports.MAX_MOVEMENT = exports.CASTER_PENALTY = exports.CRITICAL_REDUCTION = exports.PASSIVE_DEFENSE = exports.ACTIVE_DEFENSE = exports.STARTING_THEME_POINTS = exports.STARTING_RECOVERIES = exports.STARTING_HIT_POINTS = exports.STARTING_INITIATIVE = exports.STARTING_MOVEMENT = exports.NON_HUMAN_AVAILABLE_ATTRIBUTE_POINTS = void 0;
var max_movement_1 = require("../armor/max-movement");
var magic_defense_type_enum_1 = require("../character/magic-defense/magic-defense-type.enum");
var field_1 = require("../field/field");
var magic_defense_1 = require("../character/magic-defense/magic-defense");
var minor_spell_constants_1 = require("./spells/minor-spell-constants");
var spell_1 = require("../spells/spell");
var lesser_spell_constants_1 = require("./spells/lesser-spell-constants");
exports.NON_HUMAN_AVAILABLE_ATTRIBUTE_POINTS = 4;
exports.STARTING_MOVEMENT = 6;
exports.STARTING_INITIATIVE = 0;
exports.STARTING_HIT_POINTS = 0;
exports.STARTING_RECOVERIES = 6;
exports.STARTING_THEME_POINTS = 4;
// Armor constants based off of the ArmorType Enum
exports.ACTIVE_DEFENSE = [11, 13, 13, 13, 14];
exports.PASSIVE_DEFENSE = [10, 11, 11, 12, 13];
exports.CRITICAL_REDUCTION = [0, 0, 1, 2, 3];
exports.CASTER_PENALTY = [3, 3, 2, 1, 0];
exports.MAX_MOVEMENT = [
    new max_movement_1.MaxMovement(10, 0),
    new max_movement_1.MaxMovement(10, 0),
    new max_movement_1.MaxMovement(8, 0),
    new max_movement_1.MaxMovement(7, 0),
    new max_movement_1.MaxMovement(6, -1)
];
exports.SKILL_PENALTY = [0, 0, 0, 1, 2];
exports.REQUIRES_TRAINING = [false, false, false, false, true];
exports.REQUIRES_THREE_MAGIC = [false, true, false, false, false];
exports.STEALTH_INIT_BONUS = [0, 2, 4, 6];
exports.ONE_MAGIC_SPELLS = {
    Magent: {
        ...
        Spells: minor_spell_constants_1.MagentSpellList()
    },
    SpellWarden: {
        ...
        SpecialPowers: null,
        ImplementAttack: null,
        Spells: minor_spell_constants_1.SpellWardenSpellList()
    }
};
exports.TWO_MAGIC_SPELLS = {
    WarriorMage: {
        ...
        PowerPointAbilities: [],
        SpecialPowers: null,
        ImplementAttack: new spell_1.Spell(),
        Spells: lesser_spell_constants_1.WarriorMageSpellList()
    },
    Assassin: {
        ...
        SpecialPowers: null,
        ImplementAttack: new spell_1.Spell(),
        Spells: lesser_spell_constants_1.AssassinSpellList()
    },
    Cleric: {
        ...
        SpecialPowers: null,
        ImplementAttack: new spell_1.Spell(),
        Spells: lesser_spell_constants_1.ClericSpellList()
    },
    Druid: {
        Overview: "As a part of selecting the warrior mage sphere you can choose one of the following trainings.  Each training comes with passive bonuses, unique sphere specific ability and dictates the effects of your adrenaline points.",
        FeatureBonus: {
        ...
        SpecialPowers: null,
        ImplementAttack: new spell_1.Spell(),
        Spells: lesser_spell_constants_1.DruidSpellList()
    },
};
exports.SUBTHEME_BONUS = {
    ...
    Magent: exports.ONE_MAGIC_SPELLS["Magent"],
    SpellWarden: exports.ONE_MAGIC_SPELLS["SpellWarden"],
    Druid: exports.TWO_MAGIC_SPELLS["Druid"],
    WarriorMage: exports.TWO_MAGIC_SPELLS["WarriorMage"],
    Assassin: exports.TWO_MAGIC_SPELLS["Assassin"],
    Cleric: exports.TWO_MAGIC_SPELLS["Cleric"]
};
var StartingCharacterMagicDefense = /** @class */ (function () {
    function StartingCharacterMagicDefense() {
        this.Fortitude = new magic_defense_1.MagicDefense(magic_defense_type_enum_1.MagicDefenseType.Fortitude, new field_1.Field(10));
        this.Reflex = new magic_defense_1.MagicDefense(magic_defense_type_enum_1.MagicDefenseType.Reflex, new field_1.Field(10));
        this.Will = new magic_defense_1.MagicDefense(magic_defense_type_enum_1.MagicDefenseType.Will, new field_1.Field(10));
    }
    return StartingCharacterMagicDefense;
}());
exports.StartingCharacterMagicDefense = StartingCharacterMagicDefense;
var Knack = /** @class */ (function () {
    function Knack() {
    }
    return Knack;
}());
